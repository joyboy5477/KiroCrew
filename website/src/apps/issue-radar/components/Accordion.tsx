...
export default function AccordionSection({
   ...
   * stays visible while the section is COLLAPSED. That is the whole point for the
   * crews needs-a-decision count: a crew blocked on a human has to be visible
   * from any page, and a marker inside the body would disappear the moment
