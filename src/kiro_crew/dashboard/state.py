...
class _ChatSlot:
    ...
    def __init__(
        ...
        # approval window back from their first interaction onward. In-memory
        # only and deliberately not persisted — after a restart nobody is at the
        # keyboard, which is exactly when the fast deny must apply.
